      ...
      for (int axisIndex = 0;
        ...
        for (int seriesIndex = 0;
          ...
          if (series.xAxisName != null
              ? series.xAxisName == axis._name ||
                  !axisNames.contains(series.xAxisName) ||
          ...
          } else if (series.yAxisName != null
              ? series.yAxisName == axis._name ||
                  !axisNames.contains(series.yAxisName) ||
