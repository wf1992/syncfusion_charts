...
class _TrendlinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (CartesianSeries<dynamic, dynamic> series
        ...
        for (Trendline trendline in series.trendlines) {
          if (trendline._isNeedRender && trendline.isVisible) {
            ...
            renderTrendlineEvent(
                ...
                chart._chartSeries.visibleSeries.indexOf(series),
                series._seriesName);
            if (trendline.type == TrendlineType.linear) {
              ...
              final List<Offset> polynomialPoints = trendline
                  .getPolynomialCurve(trendline._pointsData, series, chart);
                ...
                for (CartesianChartPoint<dynamic> point
                  ...
                  if (point.isVisible && point.isGap != true) {
                    if (trendline.markerSettings.shape ==
                      ...
                      _drawImageMarker(series, canvas, point.markerPoint.x,
                          point.markerPoint.y);
                    }
