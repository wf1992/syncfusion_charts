...
class BollingerBandIndicator<T, D> extends TechnicalIndicators<T, D> {
  ...
  void _initDataSource(BollingerBandIndicator<dynamic, dynamic> indicator) {
    ...
    final List<CartesianChartPoint<dynamic>> bandCollection =
        <CartesianChartPoint<dynamic>>[];
    final CartesianSeries<dynamic, dynamic> upperSeries =
        indicator._targetSeries[start + 1];
    final CartesianSeries<dynamic, dynamic> lowerSeries =
        indicator._targetSeries[start + 2];
    final CartesianSeries<dynamic, dynamic> signalSeries =
        indicator._targetSeries[start];
    final CartesianSeries<dynamic, dynamic> rangeAreaSeries =
        enableBand ? indicator._targetSeries[0] : null;
    ...
    if (enableBand) {
      _setSeriesRange(
          bandCollection, indicator, xValues, indicator._targetSeries[0]);
    }
    _setSeriesRange(
        signalCollection, indicator, xValues, indicator._targetSeries[start]);
