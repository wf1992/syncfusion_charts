...
// ignore:unused_element
  ...
  void _initDataSource(RsiIndicator<dynamic, dynamic> indicator) {
    ...
    _setSeriesRange(
        signalCollection, indicator, signalXValues, indicator._targetSeries[0]);
    if (indicator.showZones) {
      _setSeriesRange(
          upperCollection, indicator, xValues, indicator._targetSeries[1]);
      _setSeriesRange(
          lowerCollection, indicator, xValues, indicator._targetSeries[2]);
    }
  }
}
