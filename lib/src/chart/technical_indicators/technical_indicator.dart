...
class TechnicalIndicators<T, D> {
  ...
  //ignore: prefer_final_fields
  List<CartesianSeries<dynamic, dynamic>> _targetSeries =
  ...
  CartesianChartPoint<dynamic> _getDataPoint(
    ...
    if (indicator is MacdIndicator && series._seriesType == 'column') {
    ...
    final CartesianSeries<dynamic, dynamic> series = name == 'rangearea'
        ...
        : (name == 'Histogram'
            ...
            : LineSeries<dynamic, dynamic>(
                ...
                yValueMapper: null,
                dataSource: null));
    series._visible = indicator._visible;
    series._chart = chart;
    series._seriesType = name == 'rangearea'
        ? 'rangearea'
        : (name == 'Histogram' ? 'column' : 'line');
    series._isIndicator = true;
    series._seriesName = indicator._name;
    indicator._targetSeries.add(series);
  }
  ...
  void _setSeriesRange(List<CartesianChartPoint<dynamic>> points,
      ...
      [CartesianSeries<dynamic, dynamic> series]) {
    if (series == null) {
      indicator._targetSeries[0]._dataPoints = points;
      indicator._targetSeries[0]._xValues = xValues;
    } else {
      series._dataPoints = points;
      series._xValues = xValues;
    }
  }
