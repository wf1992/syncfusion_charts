...
class _LegendContainer extends StatelessWidget {
  ...
  Widget _getWidget(
    ...
    if (needLegendTitle) {
      ...
      final Color color = chart.legend.name.textStyle.color ??
          chart._chartState._chartTheme.legendTitleColor;
      final double fontSize = chart.legend.name.textStyle.fontSize;
      final String fontFamily = chart.legend.name.textStyle.fontFamily;
      final FontStyle fontStyle = chart.legend.name.textStyle.fontStyle;
      final FontWeight fontWeight = chart.legend.name.textStyle.fontWeight;
      widget = Container(
          child: Column(
