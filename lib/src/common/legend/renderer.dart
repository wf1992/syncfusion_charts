  ...
  void _drawLegendShape(
    ...
    final double width = (legendRenderContext.series.legendIconType ==
            ...
            (legendRenderContext.series._seriesType == 'line' ||
                ...
                legendRenderContext.series._seriesType.contains('stackedline')))
        ? size.width / 1.5
        : size.width;
    ...
    if (color != null) {
      final Paint fillPaint = Paint()
        ...
        ..strokeWidth = legend.iconBorderWidth > 0
            ...
            : (legendRenderContext.series._seriesType.contains('hilo') ||
                    legendRenderContext.series._seriesType == 'candle' ||
