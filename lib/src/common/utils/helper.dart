...
Widget _renderChartTitle(dynamic widget) {
  Widget titleWidget;
  if (widget.name.text != null && widget.name.text.isNotEmpty) {
    final Color color = widget.name.textStyle.color ??
        widget._chartState._chartTheme.titleTextColor;
    final double fontSize = widget.name.textStyle.fontSize;
    final String fontFamily = widget.name.textStyle.fontFamily;
    final FontStyle fontStyle = widget.name.textStyle.fontStyle;
    final FontWeight fontWeight = widget.name.textStyle.fontWeight;
    titleWidget = Container(
      ...
      child: Container(
          ...
          decoration: BoxDecoration(
              color: widget.name.backgroundColor ??
                  widget._chartState._chartTheme.titleBackgroundColor,
              border: Border.all(
                  color: widget.name.borderColor ??
                      widget._chartState._chartTheme.titleTextColor,
                  width: widget.name.borderWidth)),
      ...
      alignment: (widget.name.alignment == ChartAlignment.near)
          ? Alignment.topLeft
          : (widget.name.alignment == ChartAlignment.far)
              ? Alignment.topRight
              : (widget.name.alignment == ChartAlignment.center)
                  ? Alignment.topCenter
                  : Alignment.topCenter,
    );
  } else {
