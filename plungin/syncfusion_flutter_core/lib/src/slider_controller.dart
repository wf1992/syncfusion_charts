...
///
/// [start] - represents the currently selected start value of the range selector.
...
class RangeController extends ChangeNotifier {
  ...
  /// The left thumb of the range selector was drawn corresponding to this value.
  ///
  /// The [end] represents the currently selected value of the range selector.
  /// The right thumb of the range selector was drawn corresponding to this value.
  ///
  /// [start] and [end]
